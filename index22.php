    ...
    <div class="container-fluid py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-md-5 col-lg-7 col-xl-3">
          <video id="videoPlayer" controls class="img-fluid" poster="video-thumbnail.jpg" width="600" height="300" loop
            muted>
        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          ...
          <p align="center">Don't have an account? <a href="register.php" class="text-warning"
