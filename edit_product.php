...
if (isset($_POST['product'])) {
  ...
  if (empty($errors)) {
    ...
    $query .= " buy_price ='{$p_buy}', sale_price ='{$p_sale}', categorie_id ='{$p_cat}',size='{$p_size}',media_id='{$media_id}'";
      ...
      <div class="card shadow-lg">
        ...
        <div class="card-body">
          <form method="post" action="edit_product.php?id=<?php echo (int) $product['id'] ?>" class="clearfix">
            ...
            <button type="submit" name="product" class="btn btn-primary btn-block">Update</button>
          </form>
        </div>
      </div>
    </div>
